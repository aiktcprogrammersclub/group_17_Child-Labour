...
<a href="suggest.php">Give Suggestions</a></br>
<a href="views.php">View suggestions</a>
</div>
...
<form name ="login" action="s_next.php" method="Post" onsubmit="return chkfrm()">
							
							<div id="label">Email : *
								<input name="email" id="textbox" style="margin-top:0px;" type="text">
							</div>
							
							<div id="label">Suggestion : *
								<input name="suggest" id="textbox" style="margin-top:0px; width:200px;	height:50px;" type="text">
							</div>
...
<?php
								...
								$sql = mysql_query("select * from suggestions ORDER BY id desc");
						while ($row = mysql_fetch_array($sql)){
										
								echo"<div class='display'>
									
							<p>
								<h4>Suggestion: ".$row['suggest']." </h4>
