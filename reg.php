...
<form name ="register" action="r_next.php" method="Post" onsubmit="return chkfrm()">
							<div id="label">
					...
					<div id="label"><center> If you have already registered then click here to <a href="login.php"><font size="4"> Login </font></a></center>
					     </div>
