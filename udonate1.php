...
<font color="black" size='5'><center> Thank you for supporting us... <center> </font>

<font align="center"><h2>Offline donation<h2></font>

<form name ="doante" action="ud_next.php" method="Post" onsubmit="return chkfrm()">
<div id="label">Amount :* <input name="amt" id="textbox" style="margin-top:0px;" type="text">
</div>
